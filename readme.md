...
* If using Economical Route setting, then may run into problems in jumping.  With Economical, the Stars may not be on the "other-side" of the Sun as with Fastest routing.
